...
i18n.ad = function (opt_data, opt_sb, opt_ijData) {
  ...
  switch (opt_data.locale) {
    default:
      ...
      if (
        opt_data.profile.address.postalCode ||
        opt_data.profile.address.city
      ) {
        output += "\x3Cdiv class=c-AddressRow\x3E";
  ...
  switch (opt_data.locale) {
    default:
      ...
      if (
        opt_data.profile.address.postalCode ||
        opt_data.profile.address.city ||
        opt_data.profile.address.region
      ) {
        output += "\x3Cdiv class=c-AddressRow\x3E";
        if (opt_data.profile.address.postalCode) {
          output += i18n.postalCode(opt_data, opt_sb, opt_ijData);
...
i18n.be = function (opt_data, opt_sb, opt_ijData) {
  ...
  switch (opt_data.locale) {
    default:
      ...
      if (
        opt_data.profile.address.postalCode ||
        opt_data.profile.address.sublocality ||
        opt_data.profile.address.city
      ) {
        output += "\x3Cdiv class=c-AddressRow\x3E";
        if (opt_data.profile.address.postalCode) {
...
i18n.gn = function (opt_data, opt_sb, opt_ijData) {
  ...
  switch (opt_data.locale) {
    default:
      if (
        opt_data.profile.address.line1 ||
        opt_data.profile.address.line2 ||
        opt_data.profile.address.city
      ) {
        output += "\x3Cdiv class=c-AddressRow\x3E";
        if (opt_data.profile.address.line1) {
...
i18n.region = function (opt_data, opt_sb, opt_ijData) {
  var output = "";
  var region5 =
    opt_data.profile.address.region != null
      ? opt_data.profile.address.region
      : "";
  var regionName6 =
    (opt_data.derivedData == null
      ? null
      : opt_data.derivedData.address == null
      ? null
      : opt_data.derivedData.address.stateName) != null
      ? opt_data.derivedData == null
        ? null
        : opt_data.derivedData.address == null
        ? null
        : opt_data.derivedData.address.stateName
      : region5;
...
i18n.country = function (opt_data, opt_sb, opt_ijData) {
  ...
  var countryName9 =
    (opt_data.derivedData == null
      ...
      : opt_data.derivedData.address == null
      ? null
      : opt_data.derivedData.address.countryName) != null
      ? opt_data.derivedData == null
        ? null
        : opt_data.derivedData.address == null
        ? null
        : opt_data.derivedData.address.countryName
      : country8;
  output += "\x3C";
